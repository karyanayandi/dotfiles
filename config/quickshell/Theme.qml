...
QtObject {
    ...
    // extras
    property color g16: "#282828"
    // bg0
    property color g17: "#7c6f64"
    // bg4
    property color g18: "#928374"
    // gray
    property color g19: "#a89984"
    // fg4
    property color g20: "#fbf1c7"
    ...
    property color colHoverAlpha: Qt.rgba(102 / 255, 92 / 255, 84 / 255, 0.8)
    property color colHoverSolid: g4
    property color colAccent: g2
    property color colUrgent: g11
    property color colCritical: g11
    property color colBorder: Qt.rgba(102 / 255, 92 / 255, 84 / 255, 0.45)
    property color colBorderStrong: Qt.rgba(102 / 255, 92 / 255, 84 / 255, 0.65)
    property color colDndChecked: g10
    property color colActionBg: Qt.rgba(213 / 255, 196 / 255, 161 / 255, 0.55)
    property color colShadow: Qt.rgba(29 / 255, 32 / 255, 33 / 255, 0.45)
    property color colMeterBg: Qt.rgba(80 / 255, 73 / 255, 69 / 255, 0.9)
    property color colMeterFg: g5
    property color colMuted: g4
    property color colBgAlpha095: Qt.rgba(29 / 255, 32 / 255, 33 / 255, 0.95)
    property color colBgAlpha085: Qt.rgba(29 / 255, 32 / 255, 33 / 255, 0.85)
    property color colBgAlpha078: Qt.rgba(29 / 255, 32 / 255, 33 / 255, 0.78)
    property string fontUi: "sans-serif"
    property string fontFamily: "JetBrainsMono NF"
    property color colLauncherBg: Qt.rgba(29 / 255, 32 / 255, 33 / 255, 0.98)
    property color colLauncherBorder: Qt.rgba(124 / 255, 111 / 255, 100 / 255, 0.35)
    property color colInputBg: Qt.rgba(60 / 255, 56 / 255, 54 / 255, 0.65)
    property color colChipBg: Qt.rgba(80 / 255, 73 / 255, 69 / 255, 0.9)
