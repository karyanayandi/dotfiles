            ...
            delegate: Rectangle {
                ...
                Rectangle {
                    ...
                    Timer {
                        id: ttl
                        interval: {
                            if (row.notif.urgency === NotificationUrgency.Low) return Config.popupTtlLow
                            if (row.notif.urgency === NotificationUrgency.Critical) return Config.popupTtlCritical
                    ...
                    Comp.NotificationCard {
                        id: card
                        anchors.left: parent.left; anchors.right: parent.right; anchors.top: parent.top
                        anchors.leftMargin: 10; anchors.rightMargin: 10; anchors.topMargin: 26; anchors.bottomMargin: 14
